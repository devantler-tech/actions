...
trusted_same_workflow='{"workflow_runs":[{"id":110,"workflow_id":7,"created_at":"2026-07-28T20:00:03Z","actor":{"login":"devantler"},"triggering_actor":{"login":"devantler"},"pull_requests":[{"number":42}]}]}'
trusted_other_workflow='{"workflow_runs":[{"id":110,"workflow_id":8,"created_at":"2026-07-28T20:00:03Z","actor":{"login":"devantler"},"triggering_actor":{"login":"devantler"},"pull_requests":[{"number":42}]}]}'
