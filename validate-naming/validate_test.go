...
func TestNamingRules(t *testing.T) {
	cases := []struct {
		...
		{name: "already plural kind", files: map[string]string{"k8s/endpoints/endpoints-a.yaml": "kind: Endpoints\n", "k8s/endpoints/endpoints-b.yaml": "kind: Endpoints\n"}},
		{name: "configured already plural kind", files: map[string]string{"k8s/endpoints/database.yaml": "kind: Endpoints\n", "k8s/endpoints/cache.yaml": "kind: Endpoints\n"}, cfg: config{CRDirectories: []string{"k8s/endpoints"}}},
		{name: "already plural kind still checks directory", files: map[string]string{"k8s/endpointses/endpoints-a.yaml": "kind: Endpoints\n", "k8s/endpointses/endpoints-b.yaml": "kind: Endpoints\n"}, want: "cr-directory"},
